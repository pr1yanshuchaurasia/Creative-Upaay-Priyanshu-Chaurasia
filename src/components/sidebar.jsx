...
// Double arrow SVG as React component
  ...
  return (
    <>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <MoreVert
                className="more-icon"
                fontSize="small"
                sx={{ visibility: 'hidden', color: 'text.primary', cursor: 'pointer', ml: 1 }}
              />
            </ListItem>
          ))}
        </List>
      ...
      <Box
        textAlign="center"
        mt={2}
        sx={{ px: 1, border: '1.5px solid #ccc', borderRadius: 2, p: 2, bgcolor: '#fff' }}
      >
        <Lightbulb
          sx={{
            fontSize: 36,
